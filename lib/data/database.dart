...
class AppDataBase {
  static List<AreaEntity> get areas => [
        ...
        AreaEntity(
            ...
            title: 'Nature',
            likes: 4,
            describtion: 'neatly trimmed evergreen trees, creating a serene and picturesque environment. The path is paved with multicolored tiles and bordered by benches, suggesting a place for relaxation and leisure. The setting appears to be a park or garden, characterized by its organized landscaping and peaceful atmosphere.',
            wifi: true,
            dinner: true,
            wc: false,
            pool: true),
